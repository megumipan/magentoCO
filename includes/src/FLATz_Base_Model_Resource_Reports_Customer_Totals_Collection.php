 ...
 */
class FLATz_Base_Model_Resource_Reports_Customer_Totals_Collection extends Mage_Reports_Model_Resource_Customer_Totals_Collection {

    /**
     * 姓名の順序を切り替える
     * 
     * @param string $alias
     * @return \FLATz_Base_Model_Resource_Reports_Customer_Totals_Collection
     */
