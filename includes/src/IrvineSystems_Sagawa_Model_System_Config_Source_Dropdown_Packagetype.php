...
class IrvineSystems_Sagawa_Model_System_Config_Source_Dropdown_Packagetype
{
    public function toOptionArray()
    {
		// Get Package Codes Data Array
		$prefix = Mage::getModel('sagawa/slips')->getPkgCodeTypes();
