...
class IrvineSystems_Awardpoints_Model_Resource_Cartrules extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {    
        // Initialize cartrules Database Table
		// @see /etc/config.xml
        $this->_init('awardpoints/cartrules', 'rule_id');
    }
