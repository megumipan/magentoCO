...
class IrvineSystems_Sagawa_Model_System_Config_Source_Dropdown_Shippingmethod
{
    public function toOptionArray()
    {
		// Get Shipping Methods Data Array
		$prefix = Mage::getModel('sagawa/slips')->getShpMethodCodeTypes();
