...
class IrvineSystems_Awardpoints_Block_Adminhtml_Catalogrules_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
   /**
    ...
    */
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('awardpoints')->__('Catalog Points Rules'));
    }
    ...
    */
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('main_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('awardpoints/adminhtml_catalogrules_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('conditions_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('awardpoints/adminhtml_catalogrules_edit_tab_conditions')->toHtml(),
        ));
        ...
        $this->addTab('actions_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('awardpoints/adminhtml_catalogrules_edit_tab_actions')->toHtml(),
        ));
