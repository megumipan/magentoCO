...
class IrvineSystems_Sagawa_Model_Import extends Varien_Object
{
    // File Parameters Constants
	const FIELD_NAME_SOURCE_FILE	= 'import_file';
    const MAX_TMP_SIZE				= 64000;
    const FILE_NAME_FORMAT			= 'saga_slips_import_%s.';
    ...
    {
        return Mage::getBaseDir('var') . DS . 'saga_slips_import' . DS;
    }

    /**
     * set Upload File
     * 
     * @return IrvineSystems_Sagawa_Model_Import
     */
