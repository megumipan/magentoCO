...
class IrvineSystems_Awardpoints_Block_Adminhtml_Cartrules_Edit_Tab_Conditions extends Mage_Adminhtml_Block_Widget_Form
{
   /**
    ...
    */
    protected function _prepareForm()
    {
        ...
        $renderer = Mage::getBlockSingleton('adminhtml/widget_form_renderer_fieldset')
            ...
            ->setNewChildUrl($this->getUrl('*/adminhtml_cartrules/newConditionHtml/form/rule_conditions_fieldset'));
