...
class IrvineSystems_Yamato_Resource_Data
{
	/**
	* Cart Dimension Packer
	*
	* The array return is structure as follow:
	* ['Vol_Length']	= Volumetric Lenght			= The longest measure between the three
	* ['Vol_Circum'] 	= Volumetric Circumference	= The sum of the 2 shortest measures multiply by 2
	* ['Vol_Volume']	= Volumetric Volume			= Volumetric Lenght + Volumetric Circumference
	* ['Vol_Basic']		= Volumetric Basic			= L+W+H
	* ['Raw_Sizes']		= Raw Dimensions			= array(L,W,H)
	*
	* @return Array
	**/
	public function packStrut()
	{
		...
		$vol_Volume = $vol_Length+$vol_Circum;	// EMS req.: The Sum of Lenght and Circum
