...
class IrvineSystems_Awardpoints_Adminhtml_CatalogrulesController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    protected function _initAction() {
		//load the Layout
        $this->loadLayout()
			->_setActiveMenu('awardpoints/catalogrules')
			->_addBreadcrumb(Mage::helper('awardpoints')->__('Point Rules'), Mage::helper('awardpoints')->__('Catalog Points Rules'));
    ...
    public function indexAction() {
        ...
        $this->_initAction()
			->_addContent($this->getLayout()->createBlock('awardpoints/adminhtml_catalogrules'))
			->renderLayout();
    }
    ...
    public function editAction()
    {
		...
		$model = Mage::getModel('awardpoints/catalogrules');
        ...
        $model->getConditions()->setJsFormObject('catalogrules_conditions_fieldset');
        ...
        Mage::register('catalogrules_data', $model);

		// Load Layout and set Block Parameters
        $this->loadLayout();
        $this->_setActiveMenu('awardpoints');
        $block = $this->getLayout()->createBlock('awardpoints/adminhtml_catalogrules_edit')
            ->setData('action', $this->getUrl('*/awardpoints_catalogrules/save'));
        ...
        $this->_addContent($block)
            ->_addLeft($this->getLayout()->createBlock('awardpoints/adminhtml_catalogrules_edit_tabs'))
            ->renderLayout();
    }
    ...
    public function newConditionHtmlAction()
    {
        ...
        $model = Mage::getModel($type)
            ->setId($id)
            ->setType($type)
            ->setRule(Mage::getModel('awardpoints/catalogrules'))
