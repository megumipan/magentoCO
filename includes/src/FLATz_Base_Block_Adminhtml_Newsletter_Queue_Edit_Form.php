...
class FLATz_Base_Block_Adminhtml_Newsletter_Queue_Edit_Form extends Mage_Adminhtml_Block_Newsletter_Queue_Edit_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if ($queue->isNew()) {
            if ($queue->getTemplate()->getTemplateType() == Mage_Newsletter_Model_Template::TYPE_HTML) {
