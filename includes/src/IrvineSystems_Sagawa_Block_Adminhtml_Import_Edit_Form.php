...
class IrvineSystems_Sagawa_Block_Adminhtml_Import_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Add fieldset
     *
    ...
    protected function _prepareForm()
    {
		...
		// File Uploader Field
        $fieldset->addField(IrvineSystems_Sagawa_Model_Import::FIELD_NAME_SOURCE_FILE, 'file', array(
            'name'     => IrvineSystems_Sagawa_Model_Import::FIELD_NAME_SOURCE_FILE,
