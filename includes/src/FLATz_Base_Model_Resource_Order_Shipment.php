 ...
 */
class FLATz_Base_Model_Resource_Order_Shipment extends Mage_Sales_Model_Resource_Order_Shipment {

    /**
     * 
     * @return \FLATz_Base_Model_Resource_Order_Shipment
     */
    protected function _initVirtualGridColumns() {
        ...
        $this->addVirtualGridColumn(
                        'shipping_name', 'sales/order_address', array('billing_address_id' => 'entity_id'), $adapter->getConcatSql(array($checkedLastname, $adapter->quote(' '), $checkedFirstname))
                )
