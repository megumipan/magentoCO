 ...
 */
class FLATz_Base_Model_Mysql4_Sales_Order_Shipment extends Mage_Sales_Model_Mysql4_Order_Shipment {

    /**
     * 
     * @return \FLATz_Base_Model_Mysql4_Sales_Order_Shipment
     */
    protected function _initVirtualGridColumns() {
        ...
        $this->addVirtualGridColumn(
                        'shipping_name', 'sales/order_address', array('shipping_address_id' => 'entity_id'), 'CONCAT(IFNULL({{table}}.lastname, ""), " ", IFNULL({{table}}.firstname, ""))'
                )
