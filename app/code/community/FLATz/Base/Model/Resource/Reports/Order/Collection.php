 ...
 */
class FLATz_Base_Model_Resource_Reports_Order_Collection extends Mage_Reports_Model_Resource_Order_Collection
{
    /**
     * 姓名の順序を切り替える
     * 
     * @param string $alias
     * @return \FLATz_Base_Model_Resource_Reports_Order_Collection
     */
