...
class IrvineSystems_JapanPost_Block_Adminhtml_Slips_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
   /**
    ...
    */
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('japanpost')->__('Slips Information Data'));
    }
    ...
    */
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('order_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('japanpost/adminhtml_slips_edit_tab_order')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('delivery_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('japanpost/adminhtml_slips_edit_tab_delivery')->toHtml(),
        ));
        ...
        $this->addTab('customer_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('japanpost/adminhtml_slips_edit_tab_customer')->toHtml(),
        ));
        ...
        $this->addTab('store_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('japanpost/adminhtml_slips_edit_tab_store')->toHtml(),
        ));
