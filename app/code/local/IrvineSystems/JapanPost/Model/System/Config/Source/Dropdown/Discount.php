...
class IrvineSystems_JapanPost_Model_System_Config_Source_Dropdown_Discount
{
    public function toOptionArray()
    {
		// Get Discounts Data Array
		$prefix = Mage::getModel('japanpost/slips')->getDiscountTypes();
