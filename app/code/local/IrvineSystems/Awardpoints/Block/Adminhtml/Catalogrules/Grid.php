...
class IrvineSystems_Awardpoints_Block_Adminhtml_Catalogrules_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   /**
	...
	*/
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('awardpoints/catalogrules')->getResourceCollection();
        // Set the Collection
