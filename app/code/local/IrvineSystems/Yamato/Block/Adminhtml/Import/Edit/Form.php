...
class IrvineSystems_Yamato_Block_Adminhtml_Import_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Add fieldset
     *
    ...
    protected function _prepareForm()
    {
		...
		// File Uploader Field
        $fieldset->addField(IrvineSystems_Yamato_Model_Import::FIELD_NAME_SOURCE_FILE, 'file', array(
            'name'     => IrvineSystems_Yamato_Model_Import::FIELD_NAME_SOURCE_FILE,
