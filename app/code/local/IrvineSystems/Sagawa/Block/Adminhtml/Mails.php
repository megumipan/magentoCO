...
class IrvineSystems_Sagawa_Block_Adminhtml_Mails extends Mage_Adminhtml_Block_Widget_Grid_Container
{
   /**
    ...
    */
	public function __construct()
	{
		...
		// Set Header Title
		$this->_headerText = Mage::helper('sagawa')->__('SAGAWA - Mails Slips Management');
