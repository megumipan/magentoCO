...
class IrvineSystems_Sagawa_Model_System_Config_Source_Dropdown_Timeclass
{
    public function toOptionArray()
    {
		// Get Time Zones Data Array
		$prefix = Mage::getModel('sagawa/slips')->getTimeZoneClassesTypes();
